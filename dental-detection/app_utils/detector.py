...
class DentalDetector:
    ...
    def _load_model(self):
        ...
        # Try ultralytics backend first (handles YOLOv8/v5 models)
        try:
            ...
            print(f"[WARNING] ultralytics load failed ({e1}), trying torch.hub backend...")

        # Fallback: torch.hub backend (for older YOLOv5-only models)
        try:
            import pathlib
            ...
            print(f"[INFO] Deep learning model loaded via torch.hub from '{self.model_path}'")
